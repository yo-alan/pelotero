...
abstract class BaseReservaPeer
{
    ...
    protected static $fieldNames = array (
        BasePeer::TYPE_PHPNAME => array ('Id', 'Cliente', 'Fecha', 'Hora', 'Vigente', 'Senia', ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('id', 'cliente', 'fecha', 'hora', 'vigente', 'senia', ),
        BasePeer::TYPE_COLNAME => array (ReservaPeer::ID, ReservaPeer::CLIENTE, ReservaPeer::FECHA, ReservaPeer::HORA, ReservaPeer::VIGENTE, ReservaPeer::SENIA, ),
        BasePeer::TYPE_RAW_COLNAME => array ('ID', 'CLIENTE', 'FECHA', 'HORA', 'VIGENTE', 'SENIA', ),
        BasePeer::TYPE_FIELDNAME => array ('id', 'cliente', 'fecha', 'hora', 'vigente', 'senia', ),
    ...
    protected static $fieldKeys = array (
        BasePeer::TYPE_PHPNAME => array ('Id' => 0, 'Cliente' => 1, 'Fecha' => 2, 'Hora' => 3, 'Vigente' => 4, 'Senia' => 5, ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('id' => 0, 'cliente' => 1, 'fecha' => 2, 'hora' => 3, 'vigente' => 4, 'senia' => 5, ),
        BasePeer::TYPE_COLNAME => array (ReservaPeer::ID => 0, ReservaPeer::CLIENTE => 1, ReservaPeer::FECHA => 2, ReservaPeer::HORA => 3, ReservaPeer::VIGENTE => 4, ReservaPeer::SENIA => 5, ),
        BasePeer::TYPE_RAW_COLNAME => array ('ID' => 0, 'CLIENTE' => 1, 'FECHA' => 2, 'HORA' => 3, 'VIGENTE' => 4, 'SENIA' => 5, ),
        BasePeer::TYPE_FIELDNAME => array ('id' => 0, 'cliente' => 1, 'fecha' => 2, 'hora' => 3, 'vigente' => 4, 'senia' => 5, ),
        BasePeer::TYPE_NUM => array (0, 1, 2, 3, 4, 5, )
    );
    ...
    public static function addSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(ReservaPeer::CLIENTE);
    ...
    public static function doCountJoinCliente(Criteria $criteria, $distinct = false, PropelPDO $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        $criteria->addJoin(ReservaPeer::CLIENTE, ClientePeer::ID, $join_behavior);
