...
abstract class BaseReserva extends BaseObject implements Persistent
{
    ...
    /**
     * The value for the vigente field.
    ...
    protected $collTelefonosPartial;
    ...
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[] = ReservaPeer::ID;
        }
    ...
    public function setClienteId($v)
    {
        ...
        if ($this->cliente_id !== $v) {
            $this->cliente_id = $v;
            $this->modifiedColumns[] = ReservaPeer::CLIENTE_ID;
        }
    ...
    public function setFecha($v)
    {
        ...
        if ($this->fecha !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = ReservaPeer::FECHA;
            }
    ...
    public function setHora($v)
    {
        ...
        if ($this->hora !== $v) {
            $this->hora = $v;
            $this->modifiedColumns[] = ReservaPeer::HORA;
        }
    ...
    /**
     * Sets the value of the [vigente] column.
    ...
    public function setVigente($v)
    {
        ...
        if ($this->vigente !== $v) {
            $this->vigente = $v;
            $this->modifiedColumns[] = ReservaPeer::VIGENTE;
        }
    ...
    public function setSenia($v)
    {
        ...
        if ($this->senia !== $v) {
            $this->senia = $v;
            $this->modifiedColumns[] = ReservaPeer::SENIA;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            $this->vigente = ($row[$startcol + 4] !== null) ? (boolean) $row[$startcol + 4] : null;
            $this->senia = ($row[$startcol + 5] !== null) ? (string) $row[$startcol + 5] : null;
            $this->resetModified();
            ...
            return $startcol + 6; // 6 = ReservaPeer::NUM_HYDRATE_COLUMNS.
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(ReservaPeer::ID)) {
            $modifiedColumns[':p' . $index++]  = '`id`';
        }
        if ($this->isColumnModified(ReservaPeer::CLIENTE_ID)) {
            $modifiedColumns[':p' . $index++]  = '`cliente_id`';
        }
        if ($this->isColumnModified(ReservaPeer::FECHA)) {
            $modifiedColumns[':p' . $index++]  = '`fecha`';
        }
        if ($this->isColumnModified(ReservaPeer::HORA)) {
            $modifiedColumns[':p' . $index++]  = '`hora`';
        }
        if ($this->isColumnModified(ReservaPeer::VIGENTE)) {
            $modifiedColumns[':p' . $index++]  = '`vigente`';
        }
        if ($this->isColumnModified(ReservaPeer::SENIA)) {
            ...
            foreach ($modifiedColumns as $identifier => $columnName) {
                switch ($columnName) {
                    ...
                    case '`hora`':
                        ...
                        break;
                    case '`vigente`':
                        $stmt->bindValue($identifier, (int) $this->vigente, PDO::PARAM_INT);
                        break;
                    case '`senia`':
    ...
    {
        if (isset($alreadyDumpedObjects['Reserva'][$this->getPrimaryKey()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['Reserva'][$this->getPrimaryKey()] = true;
        ...
        $result = array(
            ...
            $keys[3] => $this->getHora(),
            $keys[4] => $this->getVigente(),
            $keys[5] => $this->getSenia(),
        );
    ...
    public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[4], $arr)) $this->setVigente($arr[$keys[4]]);
        if (array_key_exists($keys[5], $arr)) $this->setSenia($arr[$keys[5]]);
    }
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(ReservaPeer::ID)) $criteria->add(ReservaPeer::ID, $this->id);
        if ($this->isColumnModified(ReservaPeer::CLIENTE_ID)) $criteria->add(ReservaPeer::CLIENTE_ID, $this->cliente_id);
        if ($this->isColumnModified(ReservaPeer::FECHA)) $criteria->add(ReservaPeer::FECHA, $this->fecha);
        if ($this->isColumnModified(ReservaPeer::HORA)) $criteria->add(ReservaPeer::HORA, $this->hora);
        if ($this->isColumnModified(ReservaPeer::VIGENTE)) $criteria->add(ReservaPeer::VIGENTE, $this->vigente);
        if ($this->isColumnModified(ReservaPeer::SENIA)) $criteria->add(ReservaPeer::SENIA, $this->senia);
    ...
    {
        $criteria = new Criteria(ReservaPeer::DATABASE_NAME);
        $criteria->add(ReservaPeer::ID, $this->id);
    ...
    public function copyInto($copyObj, $deepCopy = false, $makeNew = true)
    {
        ...
        $copyObj->setVigente($this->getVigente());
    ...
    public function getCliente(PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aCliente === null && ($this->cliente_id !== null) && $doQuery) {
            ...
            /* The following can be used additionally to
                ...
                $this->aCliente->addReservas($this);
             */
        }
    ...
    public function clearTelefonos()
    {
        ...
        $this->collTelefonosPartial = null;

        return $this;
    }

    /**
     * reset is the collTelefonos collection loaded partially
     *
     * @return void
     */
    public function resetPartialTelefonos($v = true)
    {
        $this->collTelefonosPartial = $v;
    }
     ...
     * If this Reserva is new, it will return
    ...
    {
        $partial = $this->collTelefonosPartial && !$this->isNew();
        if (null === $this->collTelefonos || null !== $criteria  || $partial) {
            if ($this->isNew() && null === $this->collTelefonos) {
                // return empty collection
                $this->initTelefonos();
            } else {
                $collTelefonos = TelefonoQuery::create(null, $criteria)
                    ->filterByReserva($this)
                    ->find($con);
                if (null !== $criteria) {
                    if (false !== $this->collTelefonosPartial && count($collTelefonos)) {
                      $this->initTelefonos(false);

                      foreach($collTelefonos as $obj) {
                        if (false == $this->collTelefonos->contains($obj)) {
                          $this->collTelefonos->append($obj);
                        }
                      }

                      $this->collTelefonosPartial = true;
                    }

                    $collTelefonos->getInternalIterator()->rewind();
                    return $collTelefonos;
                }

                if($partial && $this->collTelefonos) {
                    foreach($this->collTelefonos as $obj) {
                        if($obj->isNew()) {
                            $collTelefonos[] = $obj;
                        }
                    }
                ...
                $this->collTelefonosPartial = false;
            }
        }
    ...
    {
        $telefonosToDelete = $this->getTelefonos(new Criteria(), $con)->diff($telefonos);

        $this->telefonosScheduledForDeletion = unserialize(serialize($telefonosToDelete));

        foreach ($telefonosToDelete as $telefonoRemoved) {
            $telefonoRemoved->setReserva(null);
        }
    ...
    public function countTelefonos(Criteria $criteria = null, $distinct = false, PropelPDO $con = null)
    {
        ...
        if (null === $this->collTelefonos || null !== $criteria || $partial) {
            ...
            if($partial && !$criteria) {
                return count($this->getTelefonos());
            }
    ...
    public function addTelefono(Telefono $l)
    {
        ...
        if (!in_array($l, $this->collTelefonos->getArrayCopy(), true)) { // only add it if the **same** object is not already associated
    ...
    protected function doAddTelefono($telefono)
    {
        ...
        $telefono->setReserva($this);
    }

    /**
     * @param	Telefono $telefono The telefono object to remove.
     * @return Reserva The current object (for fluent API support)
     */
    public function removeTelefono($telefono)
    {
        if ($this->getTelefonos()->contains($telefono)) {
            $this->collTelefonos->remove($this->collTelefonos->search($telefono));
            if (null === $this->telefonosScheduledForDeletion) {
                $this->telefonosScheduledForDeletion = clone $this->collTelefonos;
                $this->telefonosScheduledForDeletion->clear();
            }
            $this->telefonosScheduledForDeletion[]= clone $telefono;
            $telefono->setReserva(null);
        }
