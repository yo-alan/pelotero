...
abstract class BaseClientePeer
{
    ...
    protected static $fieldNames = array (
        BasePeer::TYPE_PHPNAME => array ('Id', 'Nombre', 'Telefono', ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('id', 'nombre', 'telefono', ),
        BasePeer::TYPE_COLNAME => array (ClientePeer::ID, ClientePeer::NOMBRE, ClientePeer::TELEFONO, ),
        BasePeer::TYPE_RAW_COLNAME => array ('ID', 'NOMBRE', 'TELEFONO', ),
        BasePeer::TYPE_FIELDNAME => array ('id', 'nombre', 'telefono', ),
    ...
    protected static $fieldKeys = array (
        BasePeer::TYPE_PHPNAME => array ('Id' => 0, 'Nombre' => 1, 'Telefono' => 2, ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('id' => 0, 'nombre' => 1, 'telefono' => 2, ),
        BasePeer::TYPE_COLNAME => array (ClientePeer::ID => 0, ClientePeer::NOMBRE => 1, ClientePeer::TELEFONO => 2, ),
        BasePeer::TYPE_RAW_COLNAME => array ('ID' => 0, 'NOMBRE' => 1, 'TELEFONO' => 2, ),
        BasePeer::TYPE_FIELDNAME => array ('id' => 0, 'nombre' => 1, 'telefono' => 2, ),
        BasePeer::TYPE_NUM => array (0, 1, 2, )
    );
